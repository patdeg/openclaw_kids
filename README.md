...
> **Don't run anything yet!** This stage is just explanation. You'll
> configure and deploy everything in **Stage 11** with a single script.
> Read this first so you understand what the script is setting up.
...
If you're curious, peek at the skill folders (this is safe to run —
it just lists files):
