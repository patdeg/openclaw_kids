...
echo "--------------------------------------------"
echo ""
echo "  1. Set your web UI username and password:"
echo ""
echo "     nano $DEPLOY_DIR/web.env"
echo ""
echo "     Change WEB_USERNAME to your name (e.g., Victor)"
echo "     Change WEB_PASSWORD to something YOU can remember"
echo "     (must be 16+ chars with upper, lower, digit, and"
echo "     special character — e.g., MyS3cretP@ssword!)"
echo ""
